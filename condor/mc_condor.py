...
executable_script = "run_cmssw_mc.sh"  # Executable script for CMSSW jobs
output_base = f'/eos/home-a/alshevel/scouting/data/{run}/'  # EOS output
log_dir = "logs"
...
run_query = f'dasgoclient -query="file dataset=/WtoLNu-4Jets_4J_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Winter24MiniAOD-133X_mcRun3_2024_realistic_v10-v2/MINIAODSIM" | sed "s|^|root://cms-xrd-global.cern.ch/|" > run_list/{run}.txt'
...
transfer_input_files = /afs/cern.ch/user/a/alshevel/private/CMSSW_15_0_6/src/Demo/HLTScouting/python/wntuple_cfg.py
